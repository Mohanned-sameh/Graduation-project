...
function Header() {
  ...
  return (
    <header className="text-xl border-b-2 rounded-sm bg-gradient-to-l animate-text from-[#0D3c4f] to-[#224c61] border-[#3c8eb8] flex justify-between px-20 py-5 text-[#3c8eb8]">
